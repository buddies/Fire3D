...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    py::class_<cumesh::CuMesh>(m, "CuMesh")
        ...
        .def("simplify_step_batched", &cumesh::CuMesh::simplify_step_batched)
    ...
    m.def("get_sparse_voxel_grid_active_vertices_batched", &cumesh::get_sparse_voxel_grid_active_vertices_batched);
    m.def("simple_dual_contour", &cumesh::simple_dual_contour);
    m.def("simple_dual_contour_batched", &cumesh::simple_dual_contour_batched);
}
