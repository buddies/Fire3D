...
class AdaptiveGradClipper:
    ...
    def __call__(self, accelerator, parameters, norm_type=2.0, error_if_nonfinite=False, foreach=None):
        ...
        grad_norm = accelerator.clip_grad_norm_(parameters, max_norm=max_norm, norm_type=norm_type
